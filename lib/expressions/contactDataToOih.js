...
module.exports.getExpression = function(msg)
{
  ...
  function mapMicrosoftAddressDataToOIH(addresses) {
    ...
    addresses.forEach(a => {
      addr.push({
        "street": JSON.stringify(a.street !== undefined ? a.street : JSON.stringify("")),
        "streetNumber":  JSON.stringify(JSON.stringify("")),
        "unit":  JSON.stringify(JSON.stringify("")),
        "zipCode": JSON.stringify(a.postalCode !== undefined ? a.postalCode : JSON.stringify("")),
        "city": JSON.stringify(a.city !== undefined ? a.city : JSON.stringify("")),
        "district": JSON.stringify(a.state !== undefined ? a.state : JSON.stringify("")),
        "region": JSON.stringify(a.countryOrRegion !== undefined ? a.countryOrRegion : JSON.stringify("")),
        "country":  JSON.stringify(JSON.stringify("")),
        "countryCode":  JSON.stringify(JSON.stringify("")),
        "primaryContact":  JSON.stringify(JSON.stringify("")),
